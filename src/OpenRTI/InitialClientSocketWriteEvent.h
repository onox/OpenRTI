...
#ifndef OpenRTI_InitialClientSocketWriteEvent_h
#define OpenRTI_InitialClientSocketWriteEvent_h
...
class OPENRTI_LOCAL InitialClientSocketWriteEvent : public InitialSocketWriteEvent {
public:
