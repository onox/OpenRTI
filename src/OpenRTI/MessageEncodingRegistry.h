...
public:
  ...
  MessageEncoderPair negotiateEncoding(const SharedPtr<SocketStream>& socketStream, const Clock& abstime, const std::wstring& serverName, bool& compress, StringStringListMap& parentOptions) const;
