...
class SourceStream(object):
    ...
    def writeCopyright(self):
        self.writeline('/* -*-c++-*- OpenRTI - Copyright (C) 2009-2010 Mathias Froehlich')
        self.writeline(' *')
        self.writeline(' *')
...
class MessageEncoding(object):
    def __init__(self, name):
        ...
        self.__opcodeMap = {
            ...
            'DestroyFederationExecutionResponseMessage' : 4,
            'EnumerateFederationExecutionsRequestMessage' : 5,
            'EnumerateFederationExecutionsResponseMessage' : 6,
            'InsertFederationExecutionMessage' : 7,
            'EraseFederationExecutionMessage' : 8,
            'JoinFederationExecutionRequestMessage' : 9,
            'JoinFederationExecutionResponseMessage' : 10,
            'ResignFederationExecutionRequestMessage' : 11,
            'ResignFederationExecutionResponseMessage' : 12,
            'JoinFederateNotifyMessage' : 13,
            'ResignFederateNotifyMessage' : 14,
            'ChangeDefaultResignActionMessage' : 15,
            'UpdateFederationObjectModelRequestMessage' : 16,
